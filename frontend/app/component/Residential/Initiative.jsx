        ...
        <div className="grid grid-cols-1 gap-8 lg:grid-cols-[1.05fr_0.95fr] xl:gap-15 lg:gap-0">
          <div>
            ...
            <h2 className="xl:mt-15 mt-5 font-optima xl:text-[36px] text-[28px] font-[550] xl:leading-[54px] md:leading-[40px] leading-[30px] capitalize text-[#000000]">
              An Initiative by Mansha Project
            </h2>
            ...
            <p className="xl:mt-7 mt-2 font-montserrat xl:text-[16px] text-[14px] font-normal xl:leading-[28px] leading-[25px] xl:w-full lg:w-[400px]  capitalize text-[#333333]">
              Crafted with precision, our modern floor design combines elegance
              and endurance, redefining every step of luxury living at Aagman by
              Mansha. Thoughtfully selected materials and flawless finishes
              create a seamless blend of style and strength, ensuring spaces that
              are as durable as they are beautiful. Every detail is designed to
              enhance comfort, elevate aesthetics, and offer a timeless
              foundation for your everyday life.
            </p>
            ...
            <div className="xl:mt-5 mt-2">
              <p className="font-montserrat xl:text-[16px] text-[14px] font-normal xl:leading-[28px] leading-[25px]  xl:w-full lg:w-[400px]  capitalize text-[#333333]">
                Crafted with precision, our modern floor design blends elegance
                with endurance, elevating everyday living at Aagman by Mansha.
                Designed to impress and built to last, every step you take is a
                step into refined luxury.
              </p>
            </div>
