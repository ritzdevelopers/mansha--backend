      ...
      <div className="relative z-10 mx-auto w-full max-w-8xl overflow-x-hidden px-5 py-[35px] sm:px-8 lg:px-[75px] lg:py-[70px]">
        <div className="flex flex-col items-start lg:gap-8 gap-3 lg:flex-row lg:items-center xl:items-start">
          <div className="mt-0 flex w-full flex-col items-center pt-1 text-center lg:mt-0 lg:w-[30%] lg:items-start lg:text-left xl:mt-[100px] xl:w-[26%]">
            <h2 className="font-optima text-[34px] font-bold leading-[50px] tracking-normal text-[#000000]">
            Business Insights
            </h2>
            <h3 className="lg:mt-3 mt-0 font-montserrat text-[18px] font-medium leading-[100%] tracking-normal text-[#000000]">
            Story Of ManshaGroup
            </h3>
            <p className="lg:mt-3 mt-0 w-full max-lg:max-w-none font-montserrat text-[16px] font-normal leading-[28px] tracking-normal text-[#00000099] lg:mx-0 lg:max-w-[281px]">
